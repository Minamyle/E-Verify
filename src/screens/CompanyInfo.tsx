        ...
        <div className='px-[5%] pb-32 nunito pt-24'>
            <div className='flex justify-between gap-16'>
                <div className='w-8/12 h-[30rem] flex gap-10'>
                    ...
                    <div className='border w-[35%] flex flex-col justify-evenly items-center h-[100%]'>
                        ...
                        <img src='https://d1csarkz8obe9u.cloudfront.net/posterpreviews/company-logo-design-template-e089327a5c476ce5c70c74f7359c5898_screen.jpg?ts=1672291305' className='max-w-72' />
                    </div>
                    <div className='border fw-fit min-w-[35rem] flex h-[100%] justify-evenly flex-col gap-6 px-12 py-4'>
                        ...
                        <div className='flex flex-col relative w-[100%]'>
                            <span className='absolute bg-white left-6 text-[14px] px-2'>Company email</span>
                            <input className='border bg-white mt-3 border-slate-500 rounded-xl text-md px-6 max-w-[30rem] py-2' placeholder='' />
                        </div>
                        <div className='flex flex-col relative w-[100%]'>
                            <span className='absolute bg-white left-6 text-[14px] px-2'>Company Contact</span>
                            <input className='border bg-white mt-3 border-slate-500 rounded-xl text-md px-6 max-w-[30rem] py-2' placeholder='' />
                        </div>
                        <div className='flex flex-col relative w-[100%]'>
                            <span className='absolute bg-white left-6 text-[14px] px-2'>Company Size</span>
                            <input className='border bg-white mt-3 border-slate-500 rounded-xl text-md px-6 max-w-[30rem] py-2' placeholder='' />
                        </div>
                    </div>
                    {/* </div> */}
            ...
            <div className='flex gap-12 mt-20'>
                <div className='max-w-[24.5rem] border-2 border-gray-500 rounded-md p-4'>
                    ...
                    <h1 className='text-gray-600'>15, Iyala street Akindedun, off shoprite, Alausa, Ikeja Lagos State Nigeria.</h1>
                </div>
                <div className='max-w-[24.5rem] border-2 border-gray-500 rounded-md p-4'>
                    <p className='text-[11px] mb-6'>Address</p>
                    <h1 className='text-gray-600'>15, Iyala street Akindedun, off shoprite, Alausa, Ikeja Lagos State Nigeria.</h1>
            ...
            <div className='max-w-[60rem] border border-black rounded-md mt-20 max-h-[15rem] overflow-hidden relative'>
                ...
                <img src='https://media.wired.com/photos/59269cd37034dc5f91bec0f1/191:100/w_1280,c_limit/GoogleMapTA.jpg' className='w-full h-[100%]' />
            </div>
            ...
            <div className='mt-20 max-w-[70rem]'>
                ...
                <div className=' grid grid-cols-2 mt-6 gap-4'>
                    <div className='flex flex-col relative w-[100%]'>
                        ...
                        <input className='border bg-white mt-3 border-slate-500 rounded-md text-md px-6 max-w-[30rem] py-2' placeholder='' />
                    </div>
                    <div className='flex flex-col relative w-[100%]'>
            ...
            <div className='mt-20'>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <button className='border ml-16 px-8 text-[14px] rounded-md w-fit py-2 bg-gray-300'>May</button>
                    <div className='flex flex-col gap-4'>
                        <div className='flex flex-row gap-4'>
                    ...
                    <button className='border mt-8 ml-16 px-8 text-[14px] rounded-md w-fit py-2 bg-gray-300'>June</button>
                    <div className='flex flex-col gap-4'>
                        <div className='flex flex-row gap-4'>
                            <h1 className='w-[17.5rem] text-center '>Jamse Johnson</h1>
                            <h1 className='w-[17.5rem] text-center'>Mary Jane</h1>
