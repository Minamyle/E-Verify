        ...
        <div className="w-[100vw] h-[100vh] pl-[7.5%] flex flex-row items-center nunito justify-center max-w-[100vw] overflow-x-hidden">
            <RegisterationCard>
                <div className="w-6/12 px-12 z-10 flex flex-col justify-center items-start h-[100vh]">
                    <h1 className="text-7xl leading-[5rem] font-[500]">Are you registering <br /> as a <span className="text-red-500 font-[600]">Worker</span> or as a <br /> <span className="text-yellow-400 font-[600]">Company</span></h1>
