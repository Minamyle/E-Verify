        ...
        <div className="w-[100vw] h-[100vh] px-[1rem] lg:px-0 inter container mx-auto flex flex-row items-center inter justify-center max-w-[100vw] overflow-x-hidden">
            <RegisterationCard>
                <div className="lg:w-6/12 lg:px-12 z-10 flex flex-col justify-center items-start h-[100vh]">
                    ...
                    <button className="border-2 text-xl text-[#2917FC] font-[500] mt-20 w-48 border-[#2917FC] px-8 py-3 rounded-xl">Worker</button>
                    <button className="border-2 text-xl text-[#2917FC] font-[500] w-48 mt-5 border-[#2917FC] px-8 py-3 rounded-xl">Company</button>
                </div>
            </RegisterationCard>
        </div>
    )
